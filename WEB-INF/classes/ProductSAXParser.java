...
public class ProductSAXParser extends DefaultHandler {
    ...
    String productsXml = "/home/lastwalker/apache-tomcat-7.0.34/webapps/A2/WEB-INF/classes/ProductCatalog.xml";
    ...
    public void endElement(String str1, String str2, String element) throws SAXException {
		 ...
		 if (element.equals("Accessory")) {
			...
			accessories.put("A"+x, accessory);
			x++;
	    	return;
        }
        if (element.equalsIgnoreCase("image") && keyelement=="Accessories" ) {
            accessory.setImage(evalue);
		
	    	return;
        }

        if (element.equalsIgnoreCase("name")&& keyelement=="Accessories") {
            accessory.setName(evalue);
			
	    return;
        }
		if (element.equalsIgnoreCase("company") && keyelement=="Accessories") {
            accessory.setCompany(evalue);
			
	    return;
        }
		if (element.equalsIgnoreCase("condition")&& keyelement=="Accessories") {
            accessory.setCondition(evalue);
			
	    return;
        }
		if(element.equalsIgnoreCase("price")&& keyelement=="Accessories"){
            accessory.setPrice(Float.parseFloat(evalue));
			
	    return;
        }
        if(element.equalsIgnoreCase("color")&& keyelement=="Accessories"){
           accessory.setColor(evalue);
		  
	    return;
        }
		if(element.equalsIgnoreCase("description")&& keyelement=="Accessories"){
            accessory.setDescription(evalue);
	    return;
        }
        ...
        if (element.equals("externalstorage")) {
			...
			externalstorages.put("es"+x, externalstorage);
			x++;
	    	return;
        }
